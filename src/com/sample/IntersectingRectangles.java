...
/**
 * TODO: Describe purpose and behavior of IntersectingRectangles
 */
public class IntersectingRectangles {
    ...
    public static int getNumIntersecting(Rect[] rects) {
        ...
        for (Endpoint ep : sortedByX) {
            Rect r = ep.rect;
            if (ep.isStart) {
                ret += countIntersections(sortedByY.subSet(r.yStart, false, r.yEnd, false), r.yStart.val, r.yEnd.val);
                sortedByY.add(r.yStart);
                sortedByY.add(r.yEnd);
            } else {
    ...
    public static void main(String[] args) {
        ...
        new Rect(1, 1, 3, 3), new Rect(2, 5, 4, 6), new Rect(2.5, 2, 3.5, 5.5), new Rect(8, 8, 10, 10),
                new Rect(8.5, 8.5, 11, 11) };
